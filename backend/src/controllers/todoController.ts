...
import type { CreateTodoRequest, TodoResponse, TodoRow, UpdateTodoRequest } from '../types/todo';
import type { PaginationMeta } from '../types/common';
import { sendError, sendSuccess, sendSuccessPagination } from '../utils/response';
...
export const createTodo = async (req: Request, res: Response): Promise<void> => {
    ...
    try {
        const newId = await TodoModel.craete(userId, payload.task);
